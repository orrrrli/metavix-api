...
namespace Infrastructure.Common.Persistence.Migrations
{
    ...
    [Migration("20260721200540_AddPatientDoctorRequestConcurrencyToken")]
    partial class AddPatientDoctorRequestConcurrencyToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.ClinicalGoal", b =>
                {
                    ...
                    b.Property<decimal?>("CustomAtRiskHigh")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal?>("CustomAtRiskLow")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal?>("CustomOutOfRangeHigh")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal?>("CustomOutOfRangeLow")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");
                    ...
                    b.HasIndex("PatientId", "ParameterId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Models.GlucoseReading", b =>
                {
                    ...
                    b.Property<int?>("PostprandialWindow")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Models.Patient", b =>
                {
                    ...
                    b.Property<DateOnly?>("PregnancyDueDate")
                        .HasColumnType("date");
